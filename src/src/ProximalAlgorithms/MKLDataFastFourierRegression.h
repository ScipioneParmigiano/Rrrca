...
// information.                                                               //
////////////////////////////////////////////////////////////////////////////////
#ifndef RRCA_MKLDATAFASTFOURIERREGRESSION_H_
#define RRCA_MKLDATAFASTFOURIERREGRESSION_H_
...
class MKLDataFastFourierRegression {
   ...
   */
        MKLDataFastFourierRegression(const Vector &y_, const Matrix& X_ ) :
        y(y_),
        X(X_),
        n(X_.rows()),
        m(X_.rows()) {
...
//          compute coefficient vector delta=[\beta,\gamma]' for the first time
       ...
       int solveMosek(double lambda){
           M_Model M = new mosek::fusion::Model ( "MKLDataFastFourierRegression" );
