...
// information.                                                               //
////////////////////////////////////////////////////////////////////////////////
#ifndef RRCA_CLUSTERING_INITCLUSTERTREEIMPL_H_
#define RRCA_CLUSTERING_INITCLUSTERTREEIMPL_H_
...
struct ClusterTreeInitializer<ClusterTree> {
  ...
  static void init_BoundingBox_impl(ClusterTreeBase<Derived> &CT,
    ...
    CT.node().bb_.col(0) -=
        RRCA_BBOX_THREASHOLD * CT.node().bb_.col(0).cwiseAbs();
    CT.node().bb_.col(1) +=
        RRCA_BBOX_THREASHOLD * CT.node().bb_.col(1).cwiseAbs();
